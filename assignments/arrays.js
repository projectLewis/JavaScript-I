...
// Lookup function
const categoryHelp = (call) => {
  let lookup = "";
  if (call === "id") {
    lookup = "id";
  }
  else if (call === "car_make" || call === "car make" || call === "make") {
    lookup = "car_make";;
  }
  else if (call === "car_model" || call === "car model" || call === "model") {
    lookup = "car_model";
  }
  else if (call === "car_year" || call === "car year" || call === "year") {
    lookup = "car_year";
  }
  return lookup;
};
...
const logCarInfo = (arg = "year") => {
  ...
  inventory.forEach((element) => {
    carYears.push(element[categoryHelp(arg)]);
